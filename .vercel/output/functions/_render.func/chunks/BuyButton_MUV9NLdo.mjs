import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_BKRdNm1-.mjs';
...
}, "C:/git/Astro/book-demo/src/layouts/AmazonLogo.astro", void 0);
...
Buy it on Amazon ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "C:/git/Astro/book-demo/src/components/BuyButton.astro", void 0);

const $$file = "C:/git/Astro/book-demo/src/components/BuyButton.astro";
const $$url = undefined;
